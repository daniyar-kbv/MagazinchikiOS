...
class Product: NSObject, Codable, NSCoding {
    ...
    init(id: Int?, icon: String?, description_: String?, properties: ProductProperties?, details: ProductDetails?, price: ProductPrice?, tags: [Tag]?) {
        self.id = id
        self.icon = icon
    ...
    required convenience init(coder aDecoder: NSCoder) {
        ...
        self.init(id: id, icon: icon, description_: description_, properties: properties, details: details, price: price, tags: tags)
    }
